...
//       <div className="summary-card-details">
//         <span className="summary-card-date">{formatDate(transaction.createdAt)}</span>
//         <span className="summary-card-title">{transaction.message}</span>
//         <span className="summary-card-validity">Valid till {formatDateWithTime(transaction.expiresOn)}</span>
//       </div>
//       <span className="summary-card-amount">+₹{transaction.amount}</span>
//     </div>
//   );
// };
